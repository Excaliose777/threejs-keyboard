  ...
  useGSAP(() => {
    ...
    mm.add("(prefers-reduced-motion: no-preference)", () => {
      ...
      tl.to(keyboard.position, {
        ...
        .call(() => {
          // ALLOWS SCROLLING AFTER ANIMATION
          if (typeof window !== "undefined") {
  ...
  return (
    <group>
      ...
      <group scale={scalingFactor}>
        ...
        <group ref={keycapRef}>
          <Keycap position={[0, -0.4, 2.6]} texture={1} />
          <Keycap position={[-1.4, 0, 2.3]} texture={2} />
          <Keycap position={[-1.8, 1, 1.5]} texture={3} />
          <Keycap position={[0, 1, 1]} texture={4} />
          <Keycap position={[0.7, 0.9, 1.4]} texture={5} />
          <Keycap position={[1.3, -0.3, 2.3]} texture={6} />
          <Keycap position={[0, 1, 2]} texture={7} />
          <Keycap position={[-0.7, 0.6, 2]} texture={8} />
          <Keycap position={[-0.77, 0.1, 2.8]} texture={0} />
          <Keycap position={[2, 0, 1]} texture={5} />
        </group>
      </group>
